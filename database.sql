...
-- ── Katalog-Tabellen (vom Admin befüllt) ──────────────────
...
-- ── Skins befüllen ────────────────────────────────────────
-- TODO: Füge hier deine Skins ein. Kopiere die image_url-Werte
--       aus dem base44-Dashboard oder dem Supabase Storage Browser.
--       Der "default"-Skin braucht keine image_url (wird im Code als Fallback behandelt).

INSERT INTO skins (key, name, description, cost, image_url) VALUES
  ('default', 'Fränk Classic', 'Der Originale', 0, NULL);

-- Beispiel für weitere Skins (anpassen!):
-- INSERT INTO skins (key, name, description, cost, image_url) VALUES
--   ('gold', 'Goldener Fränk', 'Glänzt wie ein Stern', 500,
--    'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/693033c50efef1894f9768b3/DEIN_SKIN_BILD.png');
